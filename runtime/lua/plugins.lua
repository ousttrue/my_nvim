...
packer.startup(function()
    ...
    use({
        ...
        config = function() vim.api.nvim_set_var("asyncrun_open", 6) end
    })
    ...
    use({
        ...
        config = function()
            vim.api.nvim_set_keymap("n", "[prefix]tt", ":NvimTreeToggle<CR>",
                                    {noremap = true})
            vim.api.nvim_set_keymap("n", "[prefix]tr", ":NvimTreeRefresh<CR>",
                                    {noremap = true})
            vim.api.nvim_set_keymap("n", "[prefix]tn", ":NvimTreeFindFile<CR>",
                                    {noremap = true})
        end
    })
    ...
    use({
        ...
        config = function()
            ...
            vim.api.nvim_set_keymap("n", "<leader>dr",
                                    ":lua require'dap'.repl.open()<CR>", opt)
            ...
            vim.api.nvim_set_keymap("n", "<leader>dn",
                                    ...
                                    opt)
            vim.api.nvim_set_keymap("n", "<leader>ds <ESC>",
