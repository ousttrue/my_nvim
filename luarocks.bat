...
SET "LUA_PATH=${packer_hererocks_lua_path};%LUA_PATH%"
IF NOT "%LUA_PATH_5_2%"=="" (
   SET "LUA_PATH_5_2=${packer_hererocks_lua_path};%LUA_PATH_5_2%"
)
IF NOT "%LUA_PATH_5_3%"=="" (
   SET "LUA_PATH_5_3=${packer_hererocks_lua_path};%LUA_PATH_5_3%"
)
SET "PATH=${packer_hererocks_path};%PATH%"
${luajit_exe} ${luarocks_lua} %*
